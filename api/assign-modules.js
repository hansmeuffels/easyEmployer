...
export default async function handler(req, res) {
  ...
  const { accessToken: rawToken, employerId, modules, providerId } = req.body;
  ...
  const apiUrl = `https://api.loket-ontw.nl/v2/providers/${providerId}/employers/${employerId}/modules`;
